...
<section id="leader-details" class="leader-section">
	<div class="background-graphic">
		<?= wp_get_attachment_image(1101, 'full'); ?>
	</div>
    <div class="container">
        <div class="breadcrumbs">
            ...
            <p class="sep">&gt;</p>
            <p class="current">Our Trip Leaders</p>
        </div>
        <h2 class="subheading">Our Trip Leaders</h2>
        <?php
        $trip_leader_id = 265; // Replace this with the actual trip leader's ID.
        $current_country_icon = 1101; // Assuming this is a constant, or fetch as needed.
