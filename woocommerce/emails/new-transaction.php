...
<p>
	<b>Date created:</b> <?= $email->format_string('{transaction_date}'); ?><br>
	<b>Description:</b> <?= $email->format_string('{transaction_description}'); ?><br>
	<b>Amount:</b> <?= $email->format_string('{transaction_amount}'); ?><br>
</p>
<?php
