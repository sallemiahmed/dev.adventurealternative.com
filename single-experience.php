<?php
/**
 * The Template for displaying all Experience posts.
 *
...
get_header();
$current_experience_ID = get_the_ID();
        ...
        <div class="trips-grid">
           <?php 
            $args = array(
                ...
                'posts_per_page' => -1,
                'meta_query' => array(
					'relation' => 'OR', // Allow for multiple conditions
					array(
						'key' => 'experience',
						'value' => $current_experience_ID,
						'compare' => '=', // Match single value
					),
					array(
						'key' => 'experience',
						'value' => '"' . $current_experience_ID . '"', // Match serialized data
						'compare' => 'LIKE',
					),
				),
            );
...
<section id="featuredLeader">
	...
	<div class="container">
		<div class="title-row">
            ...
            <div class="tripadvisor rating">
                <?= wp_get_attachment_image(451, "full"); ?>
            </div>
            <div class="googlereviews rating">
